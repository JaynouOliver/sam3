"""
Modal.com deployment for Mattoboard YOLOv8n-seg model.

Deploy:   modal deploy deploy_modal.py
Test:     modal serve deploy_modal.py   (hot-reload dev server)
"""
...
app = modal.App("mattoboard-segmentation")
...
image = (
    ...
    .add_local_file(
        "pipeline_training/sam3_distilled6/weights/best.pt",
        "/model/best.pt",
    )
)
...
class Segmenter:
    ...
    def health(self):
        ...
        return {"status": "ok", "model": "yolov8n-seg", "classes": 19}
